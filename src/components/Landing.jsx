        ...
        <div className="container  ">
            ...
            <div className="text-white text-center">
                ...
                <p className="font-normal text-lg px-[15px] md:w-[600px] max-w-full mb-[30px]">
                    ...
                    Ipsum voluptas ducimus dolor. Ipsum, optio! A, repudiandae? 
                    Voluptatem, harum numquam quisquam, itaque totam iure, 
                    nulla molestiae aliquid sapiente accusantium voluptas. Illum.
                </p>
            </div>
